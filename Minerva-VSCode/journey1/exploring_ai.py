...
def build_recommended_domains(
    ...
    if tie_info.get(
        ...
        # --------------------------------------------------------
        # IMPORTANT FIX:
        # career_scores preserves the ORIGINAL input order (see
        # normalize_career_scores), so career_scores[:2] is NOT the
        # two highest-scoring careers - it is just the first two
        # careers as listed in the assessment. That recommended a
        # 0%-scoring career as "among your strongest". Sort a local
        # copy by the deterministic percentage instead, leaving the
        # documented input-order contract of career_scores intact.
        # --------------------------------------------------------
