function VisualizationChooser({ options, selectedOptionId, explanation, onSelectOption, onExplanationChange, isDisabled }) {
  return (
    <div className="space-y-8">
      <div className="rounded-3xl border border-beige-border bg-white p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-brown">Choose the best visualization</h3>
        <p className="mt-3 text-sm text-brown-light">
          Drag the chart type that best matches the scenario, then explain your choice.
        </p>
        ...
        <div className="mt-6">
          <label className="block text-sm font-semibold text-brown">Why is this the best choice?</label>
          <textarea
            rows={3}
            value={explanation}
            ...
            placeholder="Type a short reason for your choice"
          />
        </div>
      </div>
    </div>
